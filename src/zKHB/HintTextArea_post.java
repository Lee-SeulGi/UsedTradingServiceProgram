...
public class HintTextArea_post extends JTextArea{

	Font gainFont = new Font("a소나무L", Font.PLAIN, 16);
	Font lostFont = new Font("a소나무L", Font.ITALIC, 14);
	
	
	public HintTextArea_post(final String hint) {
